    ...
    <div class="container pt-17 pb-17 pt-md-17 pb-md-17 text-center">
        <div class="row">
            <div class="col-lg-8 mx-auto">
                <h1 class="display-1 mb-3 text-white">Drilling Handling Tools & CAT IV Inspection</h1>
                <nav class="d-inline-block" aria-label="breadcrumb">
                    <ol class="breadcrumb text-white">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Drilling Handling Tools & CAT IV Inspection</li>
                    </ol>
                </nav>
                <!-- /nav -->
            </div>
        ...
        <div class="row gx-lg-8 gy-8 mt-5 mt-md-12 mt-lg-0 mb-15 align-items-center">
            ...
            <div class="col-lg-6 serviceTextContainer">
                <h2 class="display-4 mb-3">
                    Drilling Handling Tools & CAT IV Inspection
                </h2>
                <p class="lead mb-8 pe-xxl-2">
                    Dismantling, blasting, inspection, reassembling, repainting, and maintenance of drilling tools such as elevators, slips, and spiders.
                </p>
            </div>
            <!--/column -->
        </div>
