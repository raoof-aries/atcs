    ...
    <div class="container pt-17 pb-17 pt-md-17 pb-md-17 text-center">
        <div class="row">
            <div class="col-lg-8 mx-auto">
                <h1 class="display-1 mb-3 text-white">Load Test Water Bags and Tensile Load Cells</h1>
                <nav class="d-inline-block" aria-label="breadcrumb">
                    <ol class="breadcrumb text-white">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Load Test Water Bags and Tensile Load Cells</li>
                    </ol>
                </nav>
                <!-- /nav -->
            </div>
        ...
        <div class="row gx-lg-8 gy-8 mt-5 mt-md-12 mt-lg-0 mb-15 align-items-center">
            ...
            <div class="col-lg-6 serviceTextContainer">
                <h2 class="display-4 mb-3">
                    Load Test Water Bags and Tensile Load Cells
                </h2>
                <p class="lead mb-8 pe-xxl-2">
                    We offer a variety of load test water bags with capacities of 5 tons, 10 tons, 20 tons, 50 tons, and 110 tons. Additionally, our tensile load cells are available with capacities of up to 400 tons.
                </p>
            </div>
            <!--/column -->
        </div>
