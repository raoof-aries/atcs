   ...
   <div class="container pt-17 pb-17 pt-md-17 pb-md-10 text-center">
        <div class="row">
            <div class="col-12 mx-auto">
                <h1 class="display-1 mb-3 text-white">Test Weights and Testing Trays Available</h1>
                <nav class="d-inline-block" aria-label="breadcrumb">
                    <ol class="breadcrumb text-white">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Test Weights and Testing Trays Available</li>
                    </ol>
                </nav>
                <!-- /nav -->
            </div>
        ...
        <div class="row gx-lg-8 gy-8 mt-5 mt-md-12 mt-lg-0 mb-15 align-items-center">
            ...
            <div class="col-lg-6 serviceTextContainer">
                <h2 class="display-4 mb-3">
                    Test Weights and Testing Trays Available
                </h2>
                <p class="lead mb-8 pe-xxl-2">
                    Explore our range of solid test weights, available in various configurations up to 200 tons, along with testing trays that can hold up to 120 tons.
                </p>
            </div>
            <!--/column -->
        </div>
